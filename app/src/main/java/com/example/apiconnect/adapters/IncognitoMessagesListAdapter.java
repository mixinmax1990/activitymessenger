...
public class IncognitoMessagesListAdapter extends RecyclerView.Adapter<IncognitoMessagesListAdapter.ViewHolder> {
    ...
    public IncognitoMessagesListAdapter(@NonNull Context context, int resource, @NonNull List<ModelMessage> objects) {
    ...
    public ViewHolder onCreateViewHolder(@android.support.annotation.NonNull ViewGroup parent, int i) {
        ...
        if(i == 0) {
            ...
            return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.incognito_chat_message_sent, parent, false));

        }
        else {


            return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.incognito_chat_message_received, parent, false));
        }
